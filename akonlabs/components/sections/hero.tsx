...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[85vh] md:min-h-[92vh] flex items-center overflow-hidden">
      {/* Particle planet — full viewport, top to bottom */}
      <div className="absolute top-0 bottom-0 right-0 -z-10 w-[100vw] h-[100vh]">
        <ParticlePlanet particleCount={isMobile ? 8000 : 20000} />
      </div>

      {/* Text content */}
      <div className="relative z-10 w-full px-6 sm:px-12 md:px-16 py-16 md:py-20">
        <div className="max-w-[520px]">
          ...
          <motion.h1
            ...
            className="mb-5 text-2xl font-bold tracking-tight sm:text-3xl md:text-5xl lg:text-[3.25rem] leading-[1.1]"
          >
            Building the nervous
            <br />
            system for{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/60 to-white">
              agent context.
            </span>
          </motion.h1>
